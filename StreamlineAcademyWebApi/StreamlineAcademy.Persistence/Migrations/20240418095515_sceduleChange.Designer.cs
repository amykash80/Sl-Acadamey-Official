...
namespace StreamlineAcademy.Persistence.Migrations
{
    ...
    [Migration("20240418095515_sceduleChange")]
    partial class sceduleChange
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StreamlineAcademy.Domain.Entities.SuperAdmin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7730b956-98ef-4212-bde0-24c2dd3466f6"),
                            Address = "Hsr,Bangalore",
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 4, 18, 15, 25, 13, 856, DateTimeKind.Unspecified).AddTicks(6706), new TimeSpan(0, 5, 30, 0, 0)),
                            DeletedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Email = "aamir@anterntech.com",
                            IsActive = true,
                            ModifiedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ModifiedDate = new DateTimeOffset(new DateTime(2024, 4, 18, 15, 25, 13, 856, DateTimeKind.Unspecified).AddTicks(6744), new TimeSpan(0, 5, 30, 0, 0)),
                            Name = "amir",
                            Password = "2KaMItl1N0phZQToYYXLGgR4Anq5I/ss/4rii5klU+o=",
                            PhoneNumber = "8997654556",
                            PostalCode = "786545",
                            Salt = "2WMjjk2+t8owQ/6EXPH3Ug==",
                            UserRole = (byte)1
                        });
                });

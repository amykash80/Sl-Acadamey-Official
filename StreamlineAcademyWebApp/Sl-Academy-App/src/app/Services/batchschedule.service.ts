...
import {
  BatchScheduleRequestModel,
  BatchScheduleResponseModel,
  UpdateBatchScheduleModel,
} from '../Models/BatchSchedule/BatchSchedule';
...
export class BatchscheduleService {
  ...
  deleteBatchSchedule(id: string): Observable<ApiResponse<string>> {
    return this.http.delete<ApiResponse<string>>(
      this.baseUrl + 'BatchSchedule/deleteSchedule/' + id
    );
  }
  getContents(id: string): Observable<any> {
    return this.http.get<any>(
      environment.apiUrl + 'CourseContent/getContentByCourseId/' + id
    );
  }
  getBatchScheduleById(
    ...
    return this.http.get<ApiResponse<BatchScheduleResponseModel>>(
      this.baseUrl + 'BatchSchedule/getScheduleById/' + batchScheduleId
    );
  }
}

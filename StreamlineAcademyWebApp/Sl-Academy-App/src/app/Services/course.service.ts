...
import {
  CourseCategoryRequestModel,
  CourseCategoryResponse,
} from '../Models/CourseCategory/CourseCategory';
...
export class CourseService {
  ...
  createCourse(
    ...
    return this.http.post<ApiResponse<CourseResponse>>(
      this.baseUrl + 'Course/createCourses',
      courseModel
    );
  }
  courseList(id: any): Observable<ApiResponse<CourseResponse[]>> {
    return this.http.get<ApiResponse<CourseResponse[]>>(
      this.baseUrl + 'Course/getAllCoursesByAcademyId/' + id
    );
  }
  updateCourse(
  ...
  getCourseById(id: string): Observable<ApiResponse<CourseResponse>> {
    return this.http.get<ApiResponse<CourseResponse>>(
      `${this.baseUrl}Course/getCourseById/${id}`
    );
  }
  deleteCourse(id: string): Observable<ApiResponse<string>> {
    return this.http.delete<ApiResponse<string>>(
      this.baseUrl + 'Course/delete/' + id
    );
  }
  createCourseContent(
    courseContentModel: CourseContent
  ): Observable<ApiResponse<CourseContentResponse>> {
    return this.http.post<ApiResponse<CourseContentResponse>>(
      this.baseUrl + 'CourseContent/createContent',
      courseContentModel
    );
  }
  getCourseContentsByCourseId(
    courseId: string
  ): Observable<ApiResponse<CourseContentResponse[]>> {
    return this.http.get<ApiResponse<CourseContentResponse[]>>(
      this.baseUrl + 'CourseContent/getContentByCourseId/' + courseId
    );
  }
  deleteCourseContent(id: string): Observable<ApiResponse<string>> {
    return this.http.delete<ApiResponse<string>>(
      this.baseUrl + 'CourseContent/deleteContent/' + id
    );
  }
  getCourseContentById(
    ...
    return this.http.get<ApiResponse<CourseContentResponse>>(
      this.baseUrl + 'CourseContent/getContentById/' + contentId
    );
  }
  updateCourseContent(
  ...
  getCourseCategoryById(
    ...
    return this.http.get<ApiResponse<CourseCategoryResponse>>(
      this.baseUrl + 'Course/getCourseCategoryById/' + categoryId
    );
  }

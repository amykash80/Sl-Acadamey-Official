...
export class CourseresourceService {
  ...
  createCourceResource(
    courseResourceModel: FormData
  ): Observable<ApiResponse<CourseResourceResponse>> {
    return this.http.post<ApiResponse<CourseResourceResponse>>(
      this.baseUrl + 'CourseResource/addCourseResource',
      courseResourceModel
    );
  }
  getCourseResourceByCourseId(
    courseId: string
  ): Observable<ApiResponse<CourseResourceResponse[]>> {
    return this.http.get<ApiResponse<CourseResourceResponse[]>>(
      this.baseUrl + 'CourseResource/getCourseResourceByCourseId/' + courseId
    );
  }
  updateCourseResource(
  ...
  deleteCourseResource(id: string): Observable<ApiResponse<string>> {
    return this.http.delete<ApiResponse<string>>(
      this.baseUrl + 'CourseResource/deleteCourseResource/' + id
    );
  }
  getCourseResourceById(
    ...
    return this.http.get<ApiResponse<CourseResourceResponse>>(
      this.baseUrl + 'CourseResource/getCourseResourceById/' + id
    );
  }
}
